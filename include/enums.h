...
#define _ENUMS_H_
	...
	// GUI
	enum activeMenus { MAIN, NETWORK, NETWORKCLIENT, NETWORKSERVER, OPTIONS, DISPLAY, INPUTMENU, AUDIO, GAMESETUP, PLAYERSTART, COURTSELECT }; // stores which menu is set to active
	// offense / defense
