...
//    for (int x=0;x<team0ActivePlayerInstance.size();++x)
//	{
    size_t x = 0;
    size_t y = 0;
...
*/
                        logMsg("TEEE");
                        if (team1ActivePlayerInstance[x].getPlayerID() == team1ActivePlayerID[y] && team1ActivePlayerInstance[x].getInitialized())
                        {
                            logMsg("upDie????");
